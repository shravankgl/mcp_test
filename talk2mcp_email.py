...
Your entire response should be a single line starting with either FUNCTION_CALL: or FINAL_ANSWER:"""
                ...
                while iteration < max_iterations:
                    ...
                    if response_text.startswith("FUNCTION_CALL:"):
                        ...
                        # Create email body with calculation details
                        email_body = f"""Math Calculation Result

Query: {query}

Calculation Steps:
"""
                        for step in iteration_response:
                            email_body += f"- {step}\n"

                        email_body += f"\nFinal Answer: {final_answer}"

                        # Send email with results
                        recipient_email = os.getenv("RECIPIENT_EMAIL", "shravankoninti@gmail.com")
